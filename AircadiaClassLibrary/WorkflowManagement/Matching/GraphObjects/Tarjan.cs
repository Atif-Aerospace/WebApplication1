...
namespace Aircadia.WorkflowManagement
{
	class Tarjan
    {
        ...
        ///////////////Usage of above method to find cycle in graph or SCCs in a graph //////////////////
        #region "Usage of Tarjan algorithm implemented above"
             /*   var g = new Graph(new[,] {
                ...
                Program.mainWindow.WriteOutputLine("g1");
            foreach (var scc in sccs)
                Program.mainWindow.WriteOutputLine(String.Join(",",scc)); // print out*/
        #endregion
    }
}
