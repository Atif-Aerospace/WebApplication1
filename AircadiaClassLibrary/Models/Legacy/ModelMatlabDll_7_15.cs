...
{
	public class ModelMatlabDll_7_15 : ModelCSharp, IModelMatlabLegacy
	{
		...
		public ModelMatlabDll_7_15(string name, string description, List<Data> modelDataInputs, List<Data> modelDataOutputs, string dllPath, string methodName) : base(name?.Replace(" ", ""), description, modelDataInputs, modelDataOutputs)
		{
			DllPath = dllPath;
		...
		public override string ModelType => "MatlabDll_7_15";
	}
}
